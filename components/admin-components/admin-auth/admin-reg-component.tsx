            ...
            {isPendingProcess ? (
              <div className="flex flex-col items-center justify-center py-16">
                ...
                <div className="text-sm text-gray-500 text-center max-w-xs">
                  Please wait while we update admin privileges. This may take a
                  few seconds.
                </div>
              </div>
            ) : (
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 text-sm">
                      Enter the user&#39;s email to grant admin privileges. This
                      action requires careful consideration.
                    </p>
                  </div>
                ...
                <div className="border-t pt-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-600">Active Admins</div>
                    </div>
                    <div className="text-center">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <Card className="w-full max-w-md p-6 mx-4 bg-white shadow-2xl">
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Removing admin access will revoke this user's control over the
                  system, including:
                </p>
                <ul className="text-left text-sm text-gray-600 space-y-1">
                  <li>• Add new admins</li>
