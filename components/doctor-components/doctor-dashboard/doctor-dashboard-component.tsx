        ...
        <div>
          {doctorInfo.verification ? (
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="space-y-3 pt-4 border-t">
                            <button
                              onClick={() =>
                                router.push(
                                  `Channel-visited-patient-update/${selected.id}`
                                )
                              }
                              className="w-full flex items-center justify-center space-x-2 px-6 py-3 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 transition"
                            >
                              <Play className="w-5 h-5" />
                              <span>Start Consultation</span>
                            </button>
            ...
            <div className="flex items-center justify-center py-12">
              <div
                role="alert"
                className="max-w-xl w-full bg-white rounded-3xl shadow-lg p-8 text-center border border-gray-100"
              >
                ...
                <p className="text-gray-500 mb-4">
                  Your account hasn't been approved yet. You won't be able to
                  access protected doctor features until an administrator
                  approves your account.{" "}
                  <div className="bg-blue-500/10 px-5 rounded-xl my-5 py-3 border-2 border-blue-500 text-blue-600">
                    An automatic approval request has already been sent to the
                    admin . Be patient untill admin review and approve it .
                  </div>
                </p>
                ...
                <div className="text-sm text-gray-400 mb-6">
                  ...
                  <div className="my-5">
                    Account status:{" "}
                    <span className="font-medium px-1 py-0 rounded-xl bg-red-500/10 border-2 border-red-500   text-red-700">
                      {doctorInfo?.verification ? "Approved" : "Not Approved"}
                    </span>
                  </div>
                </div>
                ...
                <div className="mt-6 flex gap-3 justify-center">
                  <Button
                    className="px-5 py-2 text-sm bg-red-50 text-red-700 rounded-lg border border-red-100 hover:bg-red-100 transition"
                    onClick={async () => {
                      try {
